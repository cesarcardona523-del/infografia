...
## Contexto específico — Big Data = Big Innovation

**Referencia**: `referencias/Bigdata/bigdata-big-innovation/BigData_BigInnovation.pdf` — deck de una charla de Joan David Baena (Big Data Group Colombia) para CAOBA/CEA-IoT/Universidad EAFIT, analizado directamente. El deck original es un collage disperso de logos de patrocinadores, citas sueltas y capturas de otras fuentes (UN Global Pulse, IBM, etc.) sin una narrativa visual unificada.

**Enriquecimiento** (no replicar el collage): se extraen únicamente los 3 bloques de contenido técnico verificable y coherente que trae el deck, descartando logos de patrocinadores, agradecimientos y quotes sueltas:

1. **Las 5 V's del Big Data** (framework estándar de la industria, presente en el deck): Volumen, Variedad, Velocidad, Veracidad, Visualización.
2. **Sectores pioneros en Big Data** (listado real del deck): Banca (gestión de riesgo, prevención de fraude), Salud (diagnósticos y tratamientos oportunos), Smart Cities (seguridad, movilidad, IoT + cloud computing), Retail, Sector Agrícola (minimizar costos, prevención de averías), Educación (medir el proceso real de aprendizaje).
3. **Caso de éxito real citado en el deck: Big Data en Zara** — cifras textuales del documento (fuente: caso La Salle/The Economist 2005 "Fast Fashion"): 88 países, 7.013 tiendas, tiempo de entrega de 48 horas, sistema RFID que permite recibir pedidos en 5 segundos, reponer en 15 minutos y actualizar inventario en 3 horas, con USD 23.800 millones en ventas.

**Dato de apoyo** (también citado en el deck, sin inventar): se generan aproximadamente 2,7 zettabytes de información al día en el universo digital.

**Dirección visual**: paleta "innovación" distinta a las otras piezas del tema Bigdata — azul petróleo profundo + coral/naranja como acento (no reutilizados en las otras 3 piezas del mismo tema). Estructura en tres bloques: fila superior con las 5 V's como badges; bloque izquierdo con los sectores pioneros en grid; bloque derecho destacado con el caso Zara y sus cifras reales como tarjeta de caso de éxito. Cierre con el dato de volumen diario de datos.
