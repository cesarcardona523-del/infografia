...
- ✅ Power BI Design Files & Architecture *(Actualizada)* — tema `PowerBI` — [HTML](Construidos/PowerBI/power-bi-design-files-dashboards.html) · [PNG](Construidos/PowerBI/power-bi-design-files-dashboards.png)
- ✅ Blueprint de Arquitectura de Datos: Contratos y Confianza — tema `Arquitectura` — [HTML](Construidos/Arquitectura/blueprint-arquitectura-datos-contratos.html) · [PNG](Construidos/Arquitectura/blueprint-arquitectura-datos-contratos.png)
- ✅ Ruta de Carrera: De Cero a Analista de Datos — tema `Roles` — [HTML](Construidos/Roles/ruta-analista-datos.html) · [PNG](Construidos/Roles/ruta-analista-datos.png)
- ✅ Ruta de Carrera: Científico de Datos 2026 — tema `Roles` — [HTML](Construidos/Roles/ruta-cientifico-datos-2026.html) · [PNG](Construidos/Roles/ruta-cientifico-datos-2026.png)
- ✅ Arquitectura de Claude Code: Cómo Funciona el CLI de Anthropic — tema `Claude` — [HTML](Construidos/Claude/arquitectura-claude-code.html) · [PNG](Construidos/Claude/arquitectura-claude-code.png)
- ✅ Matriz de Habilidades: Data Engineering — tema `Data_Engineering` — [HTML](Construidos/Data_Engineering/matriz-habilidades-data-engineering.html) · [PNG](Construidos/Data_Engineering/matriz-habilidades-data-engineering.png)
- ✅ Datos Faltantes: Técnicas de Diagnóstico e Imputación — tema `Ciencia_Datos` — [HTML](Construidos/Ciencia_Datos/datos-faltantes-tecnicas.html) · [PNG](Construidos/Ciencia_Datos/datos-faltantes-tecnicas.png)
- ✅ 6 Errores Comunes con GROUP BY en SQL — tema `SQL` — [HTML](Construidos/SQL/errores-comunes-group-by.html) · [PNG](Construidos/SQL/errores-comunes-group-by.png)
- ✅ La Evolución de la Ingeniería de IA — tema `IA` — [HTML](Construidos/IA/evolucion-ingenieria-ia.html) · [PNG](Construidos/IA/evolucion-ingenieria-ia.png)
- ✅ Flujos de Trabajo con IA: Patrones de Orquestación — tema `IA` — [HTML](Construidos/IA/flujos-trabajo-ia.html) · [PNG](Construidos/IA/flujos-trabajo-ia.png)
- ✅ Las Capas del Gobierno de Datos — tema `Gobierno_de_Datos` — [HTML](Construidos/Gobierno_de_Datos/capas-gobierno-datos.html) · [PNG](Construidos/Gobierno_de_Datos/capas-gobierno-datos.png)
- ✅ Cómo Definir el Gobierno de IA — tema `IA` — [HTML](Construidos/IA/gobierno-ia-responsable.html) · [PNG](Construidos/IA/gobierno-ia-responsable.png)
- ✅ ISO 8000: Las Dimensiones de la Calidad de Datos — tema `Calidad_Datos_Gobierno` — [HTML](Construidos/Calidad_Datos_Gobierno/iso-8000-calidad-datos.html) · [PNG](Construidos/Calidad_Datos_Gobierno/iso-8000-calidad-datos.png)
- ✅ ISO 9001 y Business Intelligence: Paralelos de Gestión de Calidad — tema `Calidad_Datos_Gobierno` — [HTML](Construidos/Calidad_Datos_Gobierno/iso-9001-vs-business-intelligence.html) · [PNG](Construidos/Calidad_Datos_Gobierno/iso-9001-vs-business-intelligence.png)
- ✅ Inteligencia de Negocios con IA: El Pipeline de Valor — tema `IA` — [HTML](Construidos/IA/inteligencia-negocios-con-ia.html) · [PNG](Construidos/IA/inteligencia-negocios-con-ia.png)
- ✅ Cómo la IA Potencia el Diseño de Dashboards — tema `Dashboard` — [HTML](Construidos/Dashboard/potenciar-dashboards-con-ia.html) · [PNG](Construidos/Dashboard/potenciar-dashboards-con-ia.png)
- ✅ Niveles de Madurez en Gestión de Proyectos — tema `Proyectos` — [HTML](Construidos/Proyectos/niveles-madurez-gestion-proyectos.html) · [PNG](Construidos/Proyectos/niveles-madurez-gestion-proyectos.png)
- ✅ Tabla Periódica de Herramientas de IA para Negocios — tema `IA` — [HTML](Construidos/IA/tabla-periodica-herramientas-ia.html) · [PNG](Construidos/IA/tabla-periodica-herramientas-ia.png)
- ✅ 7 Trucos SQL para Código Óptimo — tema `SQL` — [HTML](Construidos/SQL/7-trucos-sql-optimizacion.html) · [PNG](Construidos/SQL/7-trucos-sql-optimizacion.png)
- ✅ El Ciclo de Vida de un Dashboard — tema `Gobernanza_Tableros_BI` — [HTML](Construidos/Gobernanza_Tableros_BI/ciclo-vida-dashboard.html) · [PNG](Construidos/Gobernanza_Tableros_BI/ciclo-vida-dashboard.png)
...
Cifras reales de este repositorio (calculadas con `git log`/`git shortlog` sobre este mismo git — sin servicios externos ni redirecciones a otros sitios, instantánea al 2026-09-01):

<p align="center">
  <img src="https://img.shields.io/badge/Commits-81-00C9A7?style=for-the-badge&logo=git&logoColor=white"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Archivos-486-1A56E8?style=for-the-badge&logo=files&logoColor=white"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Líneas%20%2B%2F%E2%88%92-97%2C545%20%2F%202%2C667-0B1426?style=for-the-badge&logo=git&logoColor=white"/>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Primer%20commit-2026--07--16-00C9A7?style=flat&logo=git&logoColor=white"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Último%20commit-2026--09--01-1A56E8?style=flat&logo=git&logoColor=white"/>
</p>

**Commits por autor:**

<p align="center">
  <img src="https://img.shields.io/badge/caesar523__dev-81%20commits-00C9A7?style=flat&logo=github&logoColor=white"/>
</p>
