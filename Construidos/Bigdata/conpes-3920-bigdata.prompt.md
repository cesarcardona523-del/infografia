...
## Contexto específico — CONPES 3920: Política Nacional de Big Data en Colombia

**Referencia**: `referencias/Bigdata/conpes-3920-bigdata/CONPES_3920.pdf` — Documento CONPES 3920 "Política Nacional de Explotación de Datos (Big Data)", Departamento Nacional de Planeación (DNP), MinTIC y Superintendencia de Industria y Comercio, Bogotá, 17 de abril de 2018 (116 páginas), analizado directamente.

**Contenido real extraído** (sin inventar cifras — todas verificables en el documento):

- **4 objetivos específicos**: (1) Masificar la disponibilidad de datos públicos digitales accesibles, usables y de calidad; (2) Generar seguridad jurídica para la explotación de datos; (3) Disponer de capital humano para generar valor con los datos; (4) Generar cultura de datos en el país.
- **Ciclo de generación de valor con datos** (Figura 2 del documento): Gobernanza enmarca el ciclo → Generación y recolección → Compartición y agregación → Explotación → Innovación, con Capital Humano (oferta) y Cultura de Datos (demanda) como flechas transversales que atraviesan todo el ciclo.
- **Presupuesto real**: 16.728 millones de pesos colombianos, distribuidos en 5 años (2018-2021 según Tabla 10, con seguimiento hasta 2022), liderado por MinTIC (10.420M), DNP (2.852M) e iNNpulsa/Mincomercio (1.776M) como mayores aportantes.
- **Ranking internacional real (Open Data Barometer, Gráfico 4)**: Colombia ocupa el 4° lugar en Latinoamérica, con puntajes de Preparación 72/100, Implementación 42/100 e Impacto 46/100 — una brecha real y citada entre "estar preparado" y "generar impacto real".
- **Metas de resultado (Tabla 8)**: porcentaje de entidades con al menos un proyecto de aprovechamiento de datos pasa de línea base 9,3% (2017) a meta de 90% (2022); entidades que avanzan al tercer nivel de preparación pasan de 8,7% a 50%.

**Dirección visual**: estética institucional gubernamental real, anclada en el propio branding del documento CONPES (círculo con el número del documento, azul marino + rojo de acento, tipografía serif en el título "Documento CONPES"), papel claro de fondo. Composición en tres bloques: columna izquierda con los 4 objetivos específicos numerados; centro con el ciclo de generación de valor rediseñado como diagrama de flujo horizontal enmarcado por Gobernanza arriba y Capital Humano/Cultura de Datos abajo; columna derecha con las cifras reales (presupuesto, ranking ODB, meta 2022) como panel de indicadores. Cierre con la brecha preparación-vs-impacto como hallazgo central.
